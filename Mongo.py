...
from Postgresql_vf import insert_into_postgresql
...
def main():
    ...
    firms.insert_firm_data_json("/Firms_infos.json")
    reviews.insert_scraped_data_json("/debt_relief_service_raw_reviews_COMPLETE.json")

    # Exportation des firmes et leurs avis dans un fichier JSON
    reviews.export_firms_with_reviews_to_json("firms_with_reviews.json")
